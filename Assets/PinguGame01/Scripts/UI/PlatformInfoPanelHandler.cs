...
namespace PinguGame01
{
    public class PlatformInfoPanelHandler : MonoBehaviour
    {
        ...
        [SerializeField] private Toggle hasSpeedVariation;
        [SerializeField] private Slider speedVariationSlider;
        [SerializeField] private TextMeshProUGUI speedVariationText;
        ...
        [SerializeField] private GameObject speedVariationPanel;
        ...
        public void FillValues(int index, PlatformSettings platformInfo){
            ...
            hasSpeedVariation.isOn = platformInfo.HasSpeedVariation();
            speedVariationSlider.value = platformInfo.GetSpeedVariation();
        ...
        public void UpdatePanels(){
            ...
            if(hasSpeedVariation.isOn){
                speedVariationPanel.SetActive(true);
            }else{
                speedVariationPanel.SetActive(false);
                speedVariationSlider.value = 0;
            }

            speedVariationText.text = ""+speedVariationSlider.value+"%";
        ...
        public void CreateNewSettings(){
            ...
            newSettings.ToggleSpeedVariation(hasSpeedVariation.isOn);
            newSettings.SetSpeedVariation(speedVariationSlider.value);
